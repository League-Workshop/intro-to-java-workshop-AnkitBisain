...
public class TurtleTreasureHunt implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
		...
		if (tortoiseLocationX<1700 && tortoiseLocationX>1400 && tortoiseLocationY<700 && tortoiseLocationY>400 ){
			JOptionPane.showMessageDialog(null, "Go to the little boy");
		}
		if (tortoiseLocationX<600 && tortoiseLocationX>300 && tortoiseLocationY<800 && tortoiseLocationY>500 ){
			JOptionPane.showMessageDialog(null, "Go to the parrots");
		}
		if (tortoiseLocationX<1600 && tortoiseLocationX>1100 && tortoiseLocationY<400 && tortoiseLocationY>50 ){
			JOptionPane.showMessageDialog(null, "The treasure is in the skull's nose");
		}
		if (tortoiseLocationX<700 && tortoiseLocationX>400 && tortoiseLocationY<400 && tortoiseLocationY>100 ){
