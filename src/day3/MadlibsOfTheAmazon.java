...
public class MadlibsOfTheAmazon {
	public static void main(String[] args) {
		...
		String L = JOptionPane.showInputDialog("Enter a type of liquid");
		...
		JOptionPane.showMessageDialog(null, "Piranhas are more " + A + " during the day, so cross the river at night.\nPiranhas are attracted to fresh " + L + " and will most likely take a bite out of your " + B + " if you " + V + ".\nWhatever you do, if you have an open wound, try to find another way to getback to the " + P + ".\nGood Luck!");
